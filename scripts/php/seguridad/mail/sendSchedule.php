...
function sendSchedule($dni, $turnoP, $conexion)
{
        ...
        if ($stmt->num_rows > 0) {
            ...
            <!DOCTYPE html>
                ...
                <body style='font-family: 'QuickSand', background-color: #E4E9F7; color: #707070; sans-serif; margin: 0; padding: 20px;'>
                    ...
                    <p style='margin-top: 10px;'>Se te ha asignado un nuevo turno:</p>
                    ...
                    <p style='margin-top: 10px;'>Los horarios son <b>susceptibles</b> a cambios, 1 día antes de realizar el turno accede a <a href='localhost'>tu portal </a> para comprobar cambios.</p>
                </body>
                </html>
            ";
