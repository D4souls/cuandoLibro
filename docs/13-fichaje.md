...
```
1. Empleado tiene turno asignado → [Turno: 08:00-16:00]
2. Empleado llega al trabajo → [Hora real: 08:05]
3. Empleado ficha entrada → [Sistema registra: 08:05]
4. Sistema compara horarios → [Inicio: 08:00, Fichaje: 08:05]
5. Sistema calcula diferencia → [Diferencia: 5 minutos]
6. Sistema aplica tolerancia → [Tolerancia: 5 minutos]
7. Decisión del sistema → [Dentro de tolerancia: ✅ Sin aviso]
```
